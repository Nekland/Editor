...
(function() {
    ...
    alignModule.prototype.getTemplateBefore = function() {
        ...
        tpl += '<a class="btn btn-default dropdown-toggle" data-toggle="dropdown" href="#">' +
        ...
        tpl += '<li><a href="#" class="nekland-editor-command" data-editor-module="alignment" data-editor-command="justifyLeft">' +
            this.translator.translate('alignmentLeft', {
                ucfirst: true
            }) + '</a></li>';

        tpl += '<li><a href="#" class="nekland-editor-command" data-editor-module="alignment" data-editor-command="justifyRight">' +
            this.translator.translate('alignmentRight', {
                ucfirst: true
            }) + '</a></li>';

        tpl += '<li><a href="#" class="nekland-editor-command" data-editor-module="alignment" data-editor-command="justifyCenter">' +
            this.translator.translate('alignmentCenter', {
                ucfirst: true
            }) + '</a></li>';

        tpl += '<li><a href="#" class="nekland-editor-command" data-editor-module="alignment" data-editor-command="justifyFull">' +
